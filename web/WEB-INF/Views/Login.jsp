...
<div class="container" >
         ...
         <c:url  value="/login" var="cheminlogin"/>
         <c:url value='/Home/logout' var ="cheminlogout" />
     
        <div id="login-box">

                <c:if test="${not empty loginError}" >
                    <p class="error">Erreur des informations d'identification. Essayez encore.</p>
                    <div class="error">Cause : ${LoginErrorMessage}</div>
                </c:if> 
                <h2>Connexion avec le Username et Password</h2>
