...
import java.sql.ResultSet; //ojo agregarla manuelamente
...
public class UserManager implements UserDetailsManager{
   ...
   private String getPassword(String username){
    ...
    public void createUser(UserDetails user) {
        ...
        // inserer un usager
        this.jdbcTemplate.update(insertUserQuery,user.getUsername(), user.getPassword(), true,((Usager)user).getCourriel());		
